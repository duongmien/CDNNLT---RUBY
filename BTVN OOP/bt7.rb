...
class CBGB
  ...
  def initialize
    cb1 = Nguoi.new("Lê Trịnh Bảo", 23, "QN", "001", 1000000, 200000, 50000, 1150000)
    cb2 = Nguoi.new("Nguyễn Thảo Như", 24, "DN", "002", 2000000, 200000, 50000, 2150000)
    cb3 = Nguoi.new("Hà Văn Dân", 25, "QN", "003", 3000000, 200000, 50000, 3150000)
